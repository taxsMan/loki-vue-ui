  ...
  <div class="p-2">
            ...
            <el-card shadow="hover">
              <el-form v-show="showSearch" ref="queryFormRef" :model="queryParams" :inline="true">
                ...
                <el-form-item label="模型KEY" prop="key">
                  <el-input v-model="queryParams.key" placeholder="请输入模型KEY" clearable
                            @keyup.enter="handleQuery" />
                </el-form-item>
                <el-form-item>
        ...
        <el-card shadow="hover">
          <template #header>
            <el-row :gutter="10" class="mb8">
              ...
              <el-col :span="1.5">
                <el-button type="primary" plain :disabled="multiple" icon="Download" @click="clickExportZip()">导出
                </el-button>
              </el-col>
          ...
          <el-table v-loading="loading" border :data="modelList" @selection-change="handleSelectionChange">
            ...
            <el-table-column align="center" :show-overflow-tooltip="true" prop="name" label="模型名称"
            ...
            <el-table-column align="center" :show-overflow-tooltip="true" prop="lastUpdateTime" label="更新时间"
                             width="160"></el-table-column>
            <el-table-column fixed="right" label="操作" align="center" width="170"
              ...
              <template #default="scope">
                <el-row :gutter="10" class="mb8">
                  <el-col :span="1.5">
                    <el-button link type="primary" size="small" icon="Pointer" @click="clickDesign(scope.row.id)">
                      设计流程
                    </el-button>
                  </el-col>
                  <el-col :span="1.5">
                ...
                <el-row :gutter="10" class="mb8">
                  <el-col :span="1.5">
                    <el-button link type="primary" size="small" icon="ScaleToOriginal"
                               @click="clickDeploy(scope.row.id, scope.row.key)">
                      流程部署
                    </el-button>
                  </el-col>
                  <el-col :span="1.5">
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="650px" append-to-body
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="模型名称：" prop="name">
          <el-input v-model="form.name" :disabled="ids && ids.length > 0 && billType === 'update'" maxlength="20"
                    show-word-limit />
        </el-form-item>
...
import { listModel, addModel, delModel, modelDeploy, getInfo, update, listKeys } from '@/api/workflow/model';
...
const data = reactive<PageData<ModelForm, ModelQuery>>({
  ...
  rules: {
    ...
    tag: [{ required: true, message: '流程KEY选择器不能空', trigger: 'blur' }]
  }
});
...
/** 提交按钮 */
const submitForm = () => {
  form.value.key = form.value.tag + form.value.appended;

          ...
          <div>
            ...
            <el-tabs tab-position="left" class="demo-tabs">
              <el-tab-pane label="身份存储">
                <el-form-item label="分配字段">
                  <el-input v-model="formData.field" @blur="blurFiled(formData.field)" />
                </el-form-item>
...
const blurFiled = (field :any) => {
  updateProperties({ 'flowable:field': field ? field : undefined });
};
